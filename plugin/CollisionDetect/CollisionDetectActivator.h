...
class CollisionDetectActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit CollisionDetectActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static CollisionDetectActivator *m_instance;
    static PluginContext *m_CONTEXT;
    collisionCalculator *m_detect;
};
