#ifndef SWARM_RL_EXPERIMENT_H
#define SWARM_RL_EXPERIMENT_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class swarm_rl_experimentActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit swarm_rl_experimentActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static swarm_rl_experimentActivator *m_instance;
