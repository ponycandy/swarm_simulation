...
class SwarmSimulatorActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit SwarmSimulatorActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static SwarmSimulatorActivator *m_instance;
    static PluginContext *m_CONTEXT;
    simulator_manager *manager;
};
