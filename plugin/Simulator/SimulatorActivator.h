...
class SimulatorActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit SimulatorActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static SimulatorActivator *m_instance;
    static PluginContext *m_CONTEXT;
    SimulatorManager *m_sim;
